...
export const RoadMap = () => {
  return (
    <div className='roadmap-section pb-24'>
        <div className="w-full max-w-siteWidth m-auto px-4">
            ...
            <div className="road-map-wrapper relative w-full">
                <div className="roadMap-item z-20 w-full flex justify-start pb-5">
                    <div className="w-1/2 pr-8 before-right relative">
                        <div className="item-content px-14 py-5 roadmap-bg text-center overflow-hidden rounded-[30px] h-full border-2 border-solid border-Dark shadow-Site">
                ...
                <div className="roadMap-item z-20 w-full flex justify-end pb-5">
                    <div className="w-1/2 pl-8 before-left relative">
                        <div className="item-content px-14 py-5 roadmap-bg text-center overflow-hidden rounded-[30px] h-full border-2 border-solid border-Dark shadow-Site">
                ...
                <div className="roadMap-item z-20 w-full flex justify-end">
                    <div className="w-1/2 pl-8 before-left before-last relative">
                        <div className="item-content px-14 py-5 roadmap-bg text-center overflow-hidden rounded-[30px] h-full border-2 border-solid border-Dark shadow-Site">
                ...
                <div className="line absolute top-0 z-10 w-[11px] h-full bg-[#FF3C00] border-2 border-solid border-Dark shadow-Site left-1/2 -translate-x-1/2"></div>
            </div>
        </div>
    </div>
  )
